...
<div class="container py-5">
    ...
    <div class="row">
        <div class="col-md-12 my-2 card">
            <div class="card-body">
                <h5 class="h5"><?= htmlspecialchars($post['title'], ENT_QUOTES, 'UTF-8') ?></h5>
                <span><?= htmlspecialchars($post['author'], ENT_QUOTES, 'UTF-8') ?> | <?= htmlspecialchars($post['created_at'], ENT_QUOTES, 'UTF-8') ?></span>
