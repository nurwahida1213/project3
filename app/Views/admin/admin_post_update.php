...
<body>
    ...
    <div class="container">
        <form action="" method="post" id="text-editor">
            ...
            <div class="form-group mb-2">
                <button type="submit" name="status" value="published" class="btn btnprimary"
                    style="background-color:dodgerblue">
                    Publish</button>
                <button type="submit" name="status" value="draft" class="btn btnsecondary" style="background-color:red">
